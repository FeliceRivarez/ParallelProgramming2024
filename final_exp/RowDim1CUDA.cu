//nvcc -o RowDim1CUDA RowDim1CUDA.cu -ccbin "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.39.33519\bin\Hostx64\x64\cl.exe"
#include <iostream>
#include <queue>
#include <fstream>
#include <chrono>
...
// #pragma omp for
            ...
            for (int i = 1; i < m + 1; i += 1)
            {
                ...
                // cout <<"vacancy:"<< duration2.count()-duration1.count() << endl;
                // vacancy+=duration2.count()-duration1.count();
