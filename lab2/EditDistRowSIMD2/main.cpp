            ...
            for(int i=1; i<m+1; i+=1)
            {
                ...
                for(int i1=1; i1<upper; i1+=4)
                {
                    if(mt[i][i1]!=0)
                    {
                        ...
                        {
                            __m128i t1,t2,t3;
                            t1=_mm_set_epi32(dp[i-1][i1+2],dp[i-1][i1+1],dp[i-1][i1],dp[i-1][i1-1]);
                            t2=_mm_set_epi32(dp[i-1][i1+3],dp[i-1][i1+2],dp[i-1][i1+1],dp[i-1][i1]);
                            t1=_mm_min_epi16(t1,t2);
                            t3=_mm_set_epi32(dp[i-1][mt[i][i1+3]-1]+i1-mt[i][i1+3]+2,dp[i-1][mt[i][i1+2]-1]+i1-mt[i][i1+2]+1,dp[i-1][mt[i][i1+1]-1]+i1-mt[i][i1+1],dp[i-1][mt[i][i1]-1]+i1-mt[i][i1]-1);
                            t1=_mm_min_epi16(t1,t3);
                            __m128i t4=_mm_set1_epi32(1);
